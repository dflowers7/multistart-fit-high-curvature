function tab = CollectSampledFIMFits(direcs, modelgenfun_arginnames, keepms, keepcons, inputArgFilter, inputargtables, JobFileOutputs)
% Input arguments
%   inputArgFilter
%       .name   [ string ]
...
other_arginnames = {'nworkersperjob','fun','modelgenfun', 'mfile', 'ks', 'ss', 'qs', 'hs'};
inputArgNames = [other_arginnames(:)' modelgenfun_arginnames];
outputArgNames = {'ms','cons','Gs','Ds'};
